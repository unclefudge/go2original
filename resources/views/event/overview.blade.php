        ...
        <div class="m-portlet  m-portlet--full-height ">
            ...
            <div class="m-portlet__body">
                <div class="m-scrollable m-scroller ps ps--active-y" data-scrollable="true" data-height="380" data-mobile-height="300" style="height: 380px; overflow: hidden;">
                    ...
                    <!--End::Timeline 2 -->
                    <div class="ps__rail-x" style="left: 0px; bottom: -74px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 74px; height: 380px; right: 4px;"><div class="ps__thumb-y" tabindex="0" style="top: 54px; height: 277px;"></div></div></div>
            </div>
        </div>
    </div>
</div>
