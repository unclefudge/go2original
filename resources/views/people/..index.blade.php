        ...
        <div class="m-portlet__body">
            <div class="row">
                ...
                <div class="col-2 col-sm-4 col-xs-6" style="padding-left: 0px">
                    ...
                    <button type="button" class="btn btn-sm m-btn--pill btn-primary pull-right" data-toggle="modal" data-target="#modal_create_person">Add</button>
                            ...
                            <div class="form-group row m--margin-top-20">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="m-typeahead">
                                        <input class="form-control" id="search" dir="ltr" type="text" placeholder="Search for someone" width="200px">
                                    </div>
                                    {{--}}
