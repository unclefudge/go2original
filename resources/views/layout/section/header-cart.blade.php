...
<div class="kt-header__topbar-item dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-xl">
        <form>
            <!-- begin:: Mycart -->
            <div class="kt-mycart">
                <div class="kt-mycart__head kt-head" style="background-image: url(/massets/media/misc/bg-1.jpg);">
                ...
                <div class="kt-mycart__body kt-scroll" data-scroll="true" data-height="245" data-mobile-height="200">
                    ...
                    <span class="kt-mycart__desc">
                        Profile info, Timeline etc
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="/massets/media/products/product9.jpg" title="">
                            </a>
                        </div>
                    </div>
                    ...
                    <span class="kt-mycart__desc">
                        For PHoto & Others
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="/massets/media/products/product13.jpg" title="">
                            </a>
                        </div>
                    </div>
                    ...
                    <span class="kt-mycart__desc">
                        Profile info, Timeline etc
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="/massets/media/products/product16.jpg" title="">
                            </a>
                        </div>
                    </div>
                    ...
                    <span class="kt-mycart__desc">
                        For PHoto & Others
                            ...
                            <a href="#" class="kt-mycart__pic">
                                <img src="/massets/media/products/product15.jpg" title="" alt="">
                            </a>
                        </div>
                    </div>
                </div>
